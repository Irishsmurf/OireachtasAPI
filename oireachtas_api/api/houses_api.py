...
class HousesApi(object):
    ...
    def houses(self, **kwargs):  # noqa: E501
        """Houses  # noqa: E501

        Returns a house. #### Indexes * houses  #### Mapping * House ID - Equal To - house.houseCode   # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.houses(async_req=True)
        >>> result = thread.get()
        ...
        if kwargs.get('async_req'):
            return self.houses_with_http_info(**kwargs)  # noqa: E501
        else:
            (data) = self.houses_with_http_info(**kwargs)  # noqa: E501
            return data

    def houses_with_http_info(self, **kwargs):  # noqa: E501
        """Houses  # noqa: E501

        Returns a house. #### Indexes * houses  #### Mapping * House ID - Equal To - house.houseCode   # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.houses_with_http_info(async_req=True)
        >>> result = thread.get()
        ...
        all_params = ['chamber_id', 'chamber', 'skip', 'limit']  # noqa: E501
