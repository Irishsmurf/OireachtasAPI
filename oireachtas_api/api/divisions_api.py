...
class DivisionsApi(object):
    ...
    def divisions(self, **kwargs):  # noqa: E501
        """Divisions  # noqa: E501

        This will return a list of divisions which meet certain criteria #### Indexes * division_meta  #### Mapping * Division outcome - Equal To - division.outcome * Start Date - Greater than or Equal To - division.date * End Date - Greater than or Equal To - division.date   # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.divisions(async_req=True)
        >>> result = thread.get()
        ...
        :param list[str] outcome: Filter divisions by outcome
        :param str member_id: Filter by Member uri.
        :param str debate_id: Filter by debate uri
        :param str vote_id: Division Identifier for a Single Division
        ...
        if kwargs.get('async_req'):
            return self.divisions_with_http_info(**kwargs)  # noqa: E501
        else:
            (data) = self.divisions_with_http_info(**kwargs)  # noqa: E501
            return data

    def divisions_with_http_info(self, **kwargs):  # noqa: E501
        """Divisions  # noqa: E501

        This will return a list of divisions which meet certain criteria #### Indexes * division_meta  #### Mapping * Division outcome - Equal To - division.outcome * Start Date - Greater than or Equal To - division.date * End Date - Greater than or Equal To - division.date   # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.divisions_with_http_info(async_req=True)
        >>> result = thread.get()
        ...
        all_params = ['chamber_type', 'chamber_id', 'chamber', 'date_start', 'date_end', 'skip', 'limit', 'outcome', 'member_id', 'debate_id', 'vote_id']  # noqa: E501
        ...
        if 'outcome' in params:
            ...
            collection_formats['outcome'] = 'csv'  # noqa: E501
        ...
        if 'vote_id' in params:
            query_params.append(('vote_id', params['vote_id']))  # noqa: E501
