...
class InlineResponse2004Member(object):
    ...
    def __init__(self, show_as=None, last_name=None, first_name=None, gender=None, memberships=None, uri=None, wiki_title=None, full_name=None, member_code=None, image=None, p_id=None):  # noqa: E501
