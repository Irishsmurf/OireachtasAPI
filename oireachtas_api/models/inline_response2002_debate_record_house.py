...
class InlineResponse2002DebateRecordHouse(object):
    ...
    def __init__(self, uri=None, house_no=None, show_as=None, house_code=None, committee_code=None, chamber_type=None, _configuration=None):  # noqa: E501
    ...
    def house_code(self, house_code):
        ...
        if (self._configuration.client_side_validation and
                house_code not in allowed_values):
            raise ValueError(
    ...
    def chamber_type(self, chamber_type):
        ...
        if (self._configuration.client_side_validation and
                chamber_type not in allowed_values):
            raise ValueError(
