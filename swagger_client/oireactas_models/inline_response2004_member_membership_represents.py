...
class InlineResponse2004MemberMembershipRepresents(object):
    ...
    """
    swagger_types = {
        'represent': 'InlineResponse2004MemberMembershipRepresent'
    }
    ...
    def __init__(self, represent=None, _configuration=None):  # noqa: E501
        """InlineResponse2004MemberMembershipRepresents - a model defined in Swagger"""  # noqa: E501
        if _configuration is None:
            _configuration = Configuration()
        self._configuration = _configuration

        self._represent = None
    ...
    @property
    def represent(self):
        """Gets the represent of this InlineResponse2004MemberMembershipRepresents.  # noqa: E501


        :return: The represent of this InlineResponse2004MemberMembershipRepresents.  # noqa: E501
        :rtype: InlineResponse2004MemberMembershipRepresent
        """
        return self._represent

    @represent.setter
    def represent(self, represent):
        """Sets the represent of this InlineResponse2004MemberMembershipRepresents.
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(InlineResponse2004MemberMembershipRepresents, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, InlineResponse2004MemberMembershipRepresents):
            return False
