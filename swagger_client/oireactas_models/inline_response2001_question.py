...
class InlineResponse2001Question(object):
    ...
    def __init__(self, question_number=None, uri=None, question_type=None, by=None, _date=None, debate_section=None, show_as=None, answer_text=None, to=None, _configuration=None):  # noqa: E501
    ...
    def question_number(self, question_number):
        ...
        :type: int
        """
        if self._configuration.client_side_validation and question_number is None:
    ...
    def uri(self, uri):
        ...
        if (self._configuration.client_side_validation and
                uri is not None and not re.search(r'^\/ie\/oireachtas\/question\/[0-9]{4}-[0-9]{2}-[0-9]{2}\/pq_[0-9]+$', uri)):  # noqa: E501
    ...
    def by(self, by):
        ...
        """
        if self._configuration.client_side_validation and by is None:
