...
class InlineResponse2002DebateRecordDebateSection(object):
    ...
    def __init__(self, text=None, show_as=None, debate_type=None, counts=None, speakers=None, bill=None, contains_debate=None, uri=None, debate_section_id=None, formats=None, parent_debate_section=None, _configuration=None):  # noqa: E501
    ...
    def debate_type(self, debate_type):
        ...
        :type: str
        """
        if self._configuration.client_side_validation and debate_type is None:
    ...
    def bill(self, bill):
        ...
        :type: object
        """
        if self._configuration.client_side_validation and bill is None:
    ...
    def contains_debate(self, contains_debate):
        ...
        :type: bool
        """
        if self._configuration.client_side_validation and contains_debate is None:
    ...
    def parent_debate_section(self, parent_debate_section):
        ...
        :type: object
        """
        if self._configuration.client_side_validation and parent_debate_section is None:
