...
class InlineResponse2002DebateRecordDebateSectionSpeakers(object):
    ...
    """
    swagger_types = {
        'speaker': 'Paths1debatesgetresponses200schemapropertiesresultsitemsdefinitionsdebateSpeaker'
    }
    ...
    def __init__(self, speaker=None, _configuration=None):  # noqa: E501
        """InlineResponse2002DebateRecordDebateSectionSpeakers - a model defined in Swagger"""  # noqa: E501
    ...
    @property
    def speaker(self):
        """Gets the speaker of this InlineResponse2002DebateRecordDebateSectionSpeakers.  # noqa: E501


        :return: The speaker of this InlineResponse2002DebateRecordDebateSectionSpeakers.  # noqa: E501
        :rtype: Paths1debatesgetresponses200schemapropertiesresultsitemsdefinitionsdebateSpeaker
        """
        return self._speaker

    @speaker.setter
    def speaker(self, speaker):
        """Sets the speaker of this InlineResponse2002DebateRecordDebateSectionSpeakers.
        ...
        """
        if self._configuration.client_side_validation and speaker is None:
            raise ValueError("Invalid value for `speaker`, must not be `None`")  # noqa: E501
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(InlineResponse2002DebateRecordDebateSectionSpeakers, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, InlineResponse2002DebateRecordDebateSectionSpeakers):
            return False
