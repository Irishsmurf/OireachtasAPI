...
class InlineResponse200BillAmendmentLists(object):
    ...
    """
    swagger_types = {
        'amendment_list': 'Paths1legislationgetresponses200schemapropertiesresultsitemsdefinitionsAmendmentList'
    }
    ...
    def __init__(self, amendment_list=None, _configuration=None):  # noqa: E501
        """InlineResponse200BillAmendmentLists - a model defined in Swagger"""  # noqa: E501
        if _configuration is None:
            _configuration = Configuration()
        self._configuration = _configuration

        self._amendment_list = None
        self.discriminator = None

        if amendment_list is not None:
            self.amendment_list = amendment_list

    @property
    def amendment_list(self):
        """Gets the amendment_list of this InlineResponse200BillAmendmentLists.  # noqa: E501


        :return: The amendment_list of this InlineResponse200BillAmendmentLists.  # noqa: E501
        :rtype: Paths1legislationgetresponses200schemapropertiesresultsitemsdefinitionsAmendmentList
        """
        return self._amendment_list

    @amendment_list.setter
    def amendment_list(self, amendment_list):
        """Sets the amendment_list of this InlineResponse200BillAmendmentLists.
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(InlineResponse200BillAmendmentLists, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, InlineResponse200BillAmendmentLists):
            return False
